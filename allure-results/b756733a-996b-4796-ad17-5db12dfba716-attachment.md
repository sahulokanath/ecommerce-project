...
- Name: LoginDataDrivern.spec.ts >> Login Test with username: undefined and password: Password123 @datadriven
...
```ts
  ...
  16 |     test(`Login Test with username: ${data.email} and password: ${data.password} @datadriven` , async ({ page }) => {
  17 | 
