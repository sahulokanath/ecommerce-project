...
Error: locator.click: Error: strict mode violation: locator('a[href*=\'route=account/wishlist\']') resolved to 2 elements:
    1) <a id="wishlist-total" title="Wish List (1)" href="https://naveenautomationlabs.com/opencart/index.php?route=account/wishlist">…</a> aka getByRole('link', { name: ' Wish List (1)' })
