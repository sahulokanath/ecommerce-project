          ...
          - group "Your Personal Details" [ref=e80]:
            ...
            - generic [ref=e94]:
              ...
              - textbox "* Telephone" [ref=e97]:
                ...
                - text: Sherry44@yahoo.com(875) 297-8735 x278
          - group "Your Password" [ref=e98]:
            ...
            - generic [ref=e104]:
              ...
              - textbox "* Password Confirm" [ref=e107]:
                ...
                - text: Fredy Tremblay-Koepp IIFredy Tremblay-Koepp II
...
> 65  |         return await this.msgConformation.textContent() ?? '';
  ...
  76  |     }
  77  | 
  78  |     async confrommassgege(): Promise<string> {
  79  |         return await this.msgConformation.textContent() ?? '';
  80  |     }
  81  |     //Complete the registration process
  82  | 
  83  |     async completeRegition(userdata: {
  84  |         firstName: string; lastName:
  85  |         string; email:
  86  |         string; telephone:
  87  |         string; password: string
  88  |     }): Promise<void> {
  89  |         await this.enterFirstName(userdata.firstName);
  90  |         await this.enterLastName(userdata.lastName);
  91  |         await this.enterEmail(userdata.email);
  92  |         await this.enterTelephone(userdata.telephone);
  93  |         await this.enterPassword(userdata.password);
  94  |         await this.enterConfirmPassword(userdata.password);
  95  |         await this.clickPrivacyPolicy();
  96  |         await this.clickContinue();
  97  |     }
  98  | 
  99  | }
  100 | 
